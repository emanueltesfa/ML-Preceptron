...
if __name__ == "__main__":
    ...
    #print(int((len(train_data))/ batch_size))
        ...
        final_label_mat = []
        time.sleep(1)
        for j in range( 10):#int(int(len(train_data))/ batch_size)):
            if j ==9:
                print("\n\nepoch is: ", x)
            ...
            if j == 0 and x == 0:
                ...
                layer3_data = forward_pass(train_data_new, bias3, layer_num = 3, weights = None, iteration = x+j)
                weights3 = layer3_data[1]

                layer4_data = forward_pass(layer3_data[0], bias4, layer_num = 4, weights = None, iteration = x+j)
            ...
            print("exptected: ", train_label_new)
